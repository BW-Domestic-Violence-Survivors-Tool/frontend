...
// }
// const FormikBudgetCalculator = withFormik(
//   {
//     mapPropsToValues({ monthlyBudget }) {
//       return {
//         monthlyIncome: "",
//         transportation: "",
//         food: "",
...
//   monthlyIncome: Yup.string().required("Please fill this in!"),
//   transportation: Yup.string().required("Please fill this in!"),
//   healthInsurance: Yup.string().required("Please choose a value!"),
//   carInsurance: Yup.string().required("Please choose a value!"),
//   personalLoans: Yup.string().required("Please choose a value!"),
//   carNote: Yup.string().required("Please choose a value!"),
//   newRental: Yup.string().required("Please choose a value!"),
//   utilityConnection: Yup.string().required("Please choose a value!"),
//   food: Yup.string().required("Please choose a value!")
// })
